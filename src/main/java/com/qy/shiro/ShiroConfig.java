...
import com.qy.shiro.filter.KickoutSessionControlFilter;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/user/ajaxReg","anon");
		filterChainDefinitionMap.put("/getGifCode","anon");
		filterChainDefinitionMap.put("/jsoup/test","anon");
		filterChainDefinitionMap.put("/jsoup/test1","anon");
		// 配置不会被拦截的链接 顺序判断
